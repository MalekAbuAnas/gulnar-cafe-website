  ...
  return (
    <>
      <div className="about-content-01 py-16">
        <div className="texts flex flex-col text-center container mx-auto w-2/3 space-y-10 items-center">
          <h1
            className="font-yeseva text-g-dark-brown text-5xl"
            data-aos="fade-up"
          >
            A wonderful coffee house that combines cozy ambiance and
            high-quality coffee.
          </h1>
          <p className="leading-10 text-left w-2/3 text-xl" data-aos="flip-up">
      ...
      <div className="about-content-02 py-16 flex flex-col text-center items-center justify-center space-y-10">
        <h1
          className="font-yeseva text-7xl text-g-dark-brown text-left w-3/5 ms-20"
          data-aos="fade-up"
        >
        ...
        <div className="flex w-2/3 space-x-16">
          <img
            ...
            data-aos="fade-up"
          />
          <div className="flex flex-col text-left justify-center space-y-10">
            <h1
